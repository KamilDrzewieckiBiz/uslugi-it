      ...
      <header className="fixed top-0 left-0 right-0 z-50 bg-white/70 backdrop-blur-lg border-b border-slate-200/50">
        ...
        <AnimatePresence>
          {isMenuOpen && (
            ...
            >
              <nav className="px-4 pt-2 pb-6 space-y-1" aria-label="Nawigacja mobilna">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {services.map((service, index) => (
                ...
                >
                  <div className="w-12 h-12 bg-blue-100 rounded-xl flex items-center justify-center text-blue-600 mb-6 group-hover:bg-blue-600 group-hover:text-white transition-colors" aria-hidden="true">
        ...
        <section id="platnosci" className="py-24 bg-slate-50" aria-labelledby="payments-title">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              <div>
                <h2 id="payments-title" className="text-3xl md:text-4xl font-bold text-slate-900 mb-6">Płatności i rozliczenia</h2>
                ...
                <div className="space-y-6">
                  <div className="flex gap-4">
                    <div className="flex-shrink-0 w-10 h-10 bg-white rounded-lg border border-slate-200 flex items-center justify-center text-blue-600" aria-hidden="true">
                      <Banknote size={20} />
                    </div>
                    <div>
        ...
        <section id="kontakt" className="py-24 bg-[#0a192f] text-white" aria-labelledby="contact-title">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid lg:grid-cols-2 gap-16">
              <div>
                <h2 id="contact-title" className="text-3xl md:text-4xl font-bold mb-6">Skontaktuj się ze mną</h2>
                ...
                <div className="space-y-8">
                  <div className="flex items-start gap-4">
                    <div className="w-12 h-12 rounded-xl bg-blue-600/20 border border-blue-600/30 flex items-center justify-center text-blue-400" aria-hidden="true">
                      <Mail size={24} />
                    </div>
                    <div>
        ...
        <section id="regulamin" className="py-24 bg-white" aria-labelledby="legal-title">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="flex border-b border-slate-200 mb-12" role="tablist">
              <button 
                role="tab"
                aria-selected={activeTab === 'regulamin'}
                aria-controls="panel-regulamin"
                id="tab-regulamin"
              ...
              <button 
                role="tab"
                aria-selected={activeTab === 'polityka'}
                aria-controls="panel-polityka"
                id="tab-polityka"
            ...
            <div className="prose prose-slate max-w-none">
              {activeTab === 'regulamin' ? (
                <motion.div 
                  id="panel-regulamin"
                  role="tabpanel"
                  aria-labelledby="tab-regulamin"
                  initial={{ opacity: 0, x: -10 }}
                  animate={{ opacity: 1, x: 0 }}
                  className="space-y-8"
                >
                  <h3 className="text-2xl font-bold text-slate-900">Regulamin świadczenia usług</h3>
                ...
                <motion.div 
                  ...
                  className="space-y-8"
                >
                  <h3 className="text-2xl font-bold text-slate-900">Polityka Prywatności</h3>
                  <div className="space-y-4 text-slate-600 leading-relaxed">
      ...
      <footer className="py-8 bg-slate-50 border-t border-slate-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <div className="flex items-center gap-2">
              <div className="bg-blue-600 p-1.5 rounded flex items-center justify-center text-white" aria-hidden="true">
                <Terminal size={16} />
              </div>
...
function ContactForm() {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      <div>
        <label htmlFor="contact-name" className="block text-sm font-medium text-slate-400 mb-2">Imię i nazwisko / Firma</label>
        <input 
          id="contact-name"
          type="text" 
          name="name" 
      ...
      <div>
        <label htmlFor="contact-email" className="block text-sm font-medium text-slate-400 mb-2">Adres e-mail</label>
        <input 
          id="contact-email"
          type="email" 
          name="email" 
      ...
      <div>
        <label htmlFor="contact-message" className="block text-sm font-medium text-slate-400 mb-2">Wiadomość</label>
        <textarea 
          id="contact-message"
          name="message" 
          required 
